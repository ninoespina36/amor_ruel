			...
			<div className="grid-padding mt-5">
				<div className="row">
					<div className="col-sm-4">
						<div className="row">
							<div className="col mb-4">
								<img src={require("../images/gallery/DSC_0154.jpg")} className="fit-image" alt="slide-item" onClick={() =>{ openModal();currentSlide(1) }}	/>
							</div>
					...
					<div className="col-sm-4">
						...
						<div className="row">
							<div className="col mb-4">
								<img src={require("../images/gallery/DSC_0454.jpg")} className="fit-image" alt="slide-item" 
									onClick={() =>{ openModal();currentSlide(2) }}	/>
							</div>
						</div>
